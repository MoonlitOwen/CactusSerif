...
HorizAxis.BaseScriptList  
    DFLT    ideo  	-65   825  -120     0,
    hani    ideo   	-65   825  -120     0,
    kana    ideo   	-65   825  -120     0,
    hang    ideo   	-65   825  -120     0,
    latn    romn   	-65   825  -120     0;

VertAxis.BaseTagList    icfb    icft    ideo    romn;
VertAxis.BaseScriptList
    DFLT    ideo    55   945     0   120,
    hani    ideo    55   945     0   120,
    kana    ideo    55   945     0   120,
    hang    ideo    55   945     0   120,
    latn    romn    55   945     0   120;
} BASE;
"""
